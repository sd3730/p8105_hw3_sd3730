...
Then, we make sure that the categorical variables, such as sex and education, are appropriately encoded as factors.
```{r encode_merged}
merged_data = merged_data %>%
  mutate(
    sex = factor(sex, levels = c(1, 2), labels = c("Male", "Female")),
    education = factor(education, levels = c(1:5), labels = c("Less than HS", "HS diploma", "Some college", "College graduate", "Graduate degree"))
  )
```
